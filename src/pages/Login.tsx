export default function Login() {
  return (
    <div className="container flex h-screen font-Noto">
        ...
        <div className="w-[34rem] mx-auto tracking-tighter font-medium text-3xl">
          ...
          <form className="mb-20">
            <div className="mb-7">
              ...
              <input
                className="text-base font-normal border w-full px-5 py-2.5 rounded-md focus:outline-none focus:border-primary"
                type="email"
      ...
      <div className="w-[40rem] rounded-l-[30px] p-8 bg-primary text-white tracking-tighter">
