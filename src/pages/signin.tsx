    ...
    <div className='flex h-screen font-Noto'>
      <div className='w-[1280px] p-8'>
        ...
        <div className='w-[34rem] mx-auto tracking-tighter font-medium text-3xl'>
          <div className='mb-11'>
            ...
            <p>
              <span className='font-Spoqa font-bold tracking-normal text-6xl text-primary'>RE:POST</span>입니다
            </p>
          </div>
          <form className='mb-20' onSubmit={handleSignIn}>
            ...
            <div className='flex items-center gap-3 mb-16'>
              <input 
                ...
                type='checkbox' 
                onChange={(e: ChangeEvent<HTMLInputElement>) => setCheck(e.target.checked)}
              />
      ...
      <div className='w-[640px] rounded-l-[30px] p-8 bg-primary text-[white] tracking-tighter flex flex-col justify-end'>
        <div className='text-center mb-5'>
          ...
          <p className='mb-20'>
            연차와 당직 관리<br />
            이제는 <span className='font-Spoqa tracking-normal font-bold text-2xl'>RE:POST</span>와 함께
          </p>
          <button 
