    ...
    <div className='flex h-screen font-Noto'>
      <div className='w-[1280px] p-8'>
        ...
        <div className='tracking-tighter font-medium text-3xl rounded-xl shadow-xl p-5'>
          ...
          <form onSubmit={handleSignUp} className='mb-10 flex justify-center gap-11'>
            <div>
              <div className='mb-7'>
              ...
              <div className='mb-7'>
                ...
                <div className='flex'>
                  ...
                  />
                  <button type='button' className='py-2.5 w-16 bg-secondary text-[white] rounded-md text-xs' onClick={handleEmailCheckClick}>
                    중복체크
                  </button>
                </div>
                {emailError && (
                  <div className={`text-sm ${emailError === '사용할 수 있는 이메일입니다.' ? 'text-[blue]' : 'text-[red]'}`}>{emailError}</div>
                )}
              </div>
              <div>
            ...
            <div>
              ...
              <div className='mb-7'>
                ...
                />
                {!passwordsMatch && (
                  <div className='text-sm text-[red]'>비밀번호가 일치하지 않습니다.</div>
                )}
              </div>
            </div>
          </form>
